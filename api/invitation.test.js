...
const postInvitation = require('./postInvitation.js').handler
const getInvitation = require('./getInvitation.js').handler
const getInvitationList = require('./getInvitationList.js').handler
const deleteInvitation = require('./deleteInvitation.js').handler
